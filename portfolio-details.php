      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 portfolio-info">
            ...
            <ul>
              <li><strong>類別</strong>: php design</li>
              <li><strong>製作日期</strong>: 2022/05</li>
              <li><strong>作品網站</strong>: <a href=<?=$project['web'];?>>www.example.com</a></li>
            </ul>

            <p>
              第一個獨立製作的PHP成品，可以藉由切換月份改變月曆
            </p>
          </div>
